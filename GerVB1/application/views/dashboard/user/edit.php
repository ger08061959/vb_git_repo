...
if($num_fields > 0) :
	...
	else // if too few keys, multiple columns are hideousf
...
<div class="container">
	<form class="form-horizontal" action="<?php echo $directoryName?>/<?php echo $controllerName ?>/edit/<?php echo $result['id'] ?>" method="post" accept-charset="utf-8" autocomplete="off">
