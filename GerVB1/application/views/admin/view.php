	...
	<form class="form-horizontal">
		...
		<div class="form-actions">
			<div class="pull-right">
				...
				<a class="btn confirmation-modal" href="<?php echo $directoryName?>/<?php echo $controllerName ?>/delete/<?php echo $result['id'] ?>"><i class="icon-remove"></i> Remove</a>
				<a class="btn btn-primary" href="<?php echo $directoryName?>/<?php echo $controllerName ?>/edit/<?php echo $result['id'] ?>"><i class="icon-pencil icon-white"></i> Edit</a>
			</div>
		</div>
